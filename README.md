...
- [Bounded Inductive Construction Calculus](BICC): we are developing a finitistic core theory to use for proving desired metatheoretic properties of HOCC: typechecking decidability, canonicity, normalization, conservativity of HCCC over M. Shulman's ZMC/𝕊 and thus relative consistency.
